...
const Courses = () => {
  ...
  const promise = [
    {
      image: "/TradeNeeti/assets/ctp1.webp",
    ...
    {
      image: "/TradeNeeti/assets/ctp.webp",
    ...
    {
      image: "/TradeNeeti/assets/job.webp",
    ...
    {
      image: "/TradeNeeti/assets/nisin.webp",
  ...
  return (
    <section
    className="flex flex-col items-center justify-center w-full py-3 md:py-8 bg-gray-200 md:pt-12 pb-10 md:pb-36"
>
    <h2 className="fade-in scroll-animate slide-left text-center lg:mt-20 text-2xl  m-5 xl:m-7 md:pb-6 md:text-4xl font-bold">Current Courses</h2>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 mx-auto max-w-screen-lg w-3/4">
