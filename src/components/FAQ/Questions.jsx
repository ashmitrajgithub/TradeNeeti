...
const Questions = () => {
  ...
  return (
    <>
      ...
      <section className="questions questions-container flex flex-col items-center justify-center p-8 relative bg-gray-200 overflow-hidden z-10">
        <h2 className="mb-8 text-white md:mb-12 text-2xl font-bold text-center md:text-4xl">
