...
const QuestionsItems = ({ quest, ans }) => {
  ...
  return (
    <div className="flex flex-col w-full mb-6">
      ...
      >
        <div className="flex-1 text-white text-xs md:text-lg lg:text-xl xl:text-xl">{quest}</div>
        <div className="w-8 h-5 flex items-center justify-center">
          <svg
            aria-hidden="true"
            viewBox="0 0 448 512"
            xmlns="http://www.w3.org/2000/svg"
            className={`text-white transform transition-transform w-4 duration-300 ${
